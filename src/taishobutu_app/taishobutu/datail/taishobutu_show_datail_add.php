...
<body>
  ...
  <div class="Frame">
    ...
    <form method="POST" action="http://localhost:50080/taishobutu_app/taishobutu/datail/taishobutu_show_datail_add_done.php">
      ...
      <div class="CapacityWindowlessFloorBuildingStructureCellSet">
        ...
        <div class="CapacityCellSet">
          <div class="CapacityValueCell"><input type="text" name="capacity" id="capacity"><h6>人</h6></div>
      ...
      <div class="BuildingInfoCellSet">
        <div class="BuildingInfoBottomCellCet">
          ...
          <div class="BuildingAreaCellSet">
            <div class="BuildingAreaValueCell"><input type="number" name="building_area" step="0.01" id="building_area"><h6>㎡</h6></div>
            <div class="BuildingAreaCell"><h6>建築面積</h6></div>
          </div>
          <div class="SiteAreaCellSet">
            <div class="SiteAreaValueCell"><input type="number" name="site_area" step="0.01" id="site_area"><h6>㎡</h6></div>
