...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:50080/taishobutu_app/common/sass/taishobutu/datail/fire_safety_manager/fire_safety_manager_datail.css">
...
<body>
    ...
    <form class="existingDataForm" method="post" action="http://localhost:50080/taishobutu_app/taishobutu/datail/fire_safety_manager/fire_safety_manager_add.php">
