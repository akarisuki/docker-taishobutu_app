      ...
      <?php
        ...
        while(true) {
          ...
          if($result === false) {
            ...
            echo "<td class='taishobutu_name-top'><a href='" . BASE_URL . "taishobutu_app/taishobutu/datail/taishobutu_show_datail.php?code=" . htmlspecialchars($result['code']) . "'>" . htmlspecialchars($result['taishobutu_name']) . "</a></td>";
