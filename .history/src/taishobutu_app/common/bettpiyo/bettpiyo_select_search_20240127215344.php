...
<select id="selectbox"class="input_appendix" name="search_appendix">
<?php if (!empty($search_appendix)) { ?>
    <option value="selected"><?php echo $appendix_array[$search_appendix]; ?></option>
  <?php } else { ?>
