...
(function(){
  ...
  $('#switch').on('change', function(){
    if($(this).is(':checked')) {
      ...
      $('#equipment_edit_button').css('display', 'none');
    } else {
      // メニューが閉じているときはボタンを表示する
      $('#equipment_edit_button').css('display', 'inline-block');
    }
  });
});
...
$(function(){
  ...
  $('#switch').on('change', function(){
    if($(this).is(':checked')) {
      // メニューが開いているときはボタンを非表示にする
      $('#equipment_add_done_button').css('display', 'none');
    } else {
      // メニューが閉じているときはボタンを表示する
      $('#equipment_add_done_button').css('display', 'inline-block');
    }
  });
});