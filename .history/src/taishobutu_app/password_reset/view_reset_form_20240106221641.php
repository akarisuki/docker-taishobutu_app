...
if (isset($_SESSION['errors'])) {
  ...
  unset($_SESSION['errors']); // エラーを表示した後はセッションから削除
} else {
  $errors = array();
}
...
<body>
    ...
    <div class="form-wrapper">
        ...
        <input type="hidden" name="password_reset_token" value="<?= htmlspecialchars(isset($_SESSION['password_reset_token']) ? $_SESSION['password_reset_token'] : '', ENT_QUOTES, 'UTF-8'); ?>">
            ...
            <?php var_dump($_SESSION['_csrf_token']) ;?>
