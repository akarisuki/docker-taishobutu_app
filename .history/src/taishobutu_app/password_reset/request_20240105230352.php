...
//try {
  ...
  $mail->SMTPAuth   =  false;   // SMTP authentication を有効に
  $mail->Username   = 'user@firedeptyobou119.com';  // SMTP ユーザ名
  ...
  //差出人アドレス, 差出人名
  $mail->setFrom('firedeptyobou119.com', mb_encode_mimeheader('予防１１９'));
