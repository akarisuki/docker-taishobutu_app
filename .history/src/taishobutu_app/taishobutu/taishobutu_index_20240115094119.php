    ...
    <div class="modal-content">
      ...
      <div class="form-search-mobile">
        <form action="taishobutu_index.php" method="post">
          ...
          <div>
            <label>防火対象物名</label>
            <input type="text" name="search_taishobutu_name" placeholder="すべて" value="<?php if(!empty($search_taishobutu_name)){echo $search_taishobutu_name; }?>">
          </div>
          <div>
            <label>防火対象物所在地</label>
            <input type="text" name="search_taishobutu_address" placeholder="すべて" value="<?php if(!empty($search_taishobutu_address)){echo $search_taishobutu_address; }?>">
          </div>
          <div>
            <label>延べ面積</label>
            <input type="text" name="search_total_area" placeholder="すべて"value="<?php if(!empty($search_total_area)){echo $search_total_area; }?>">
          </div>
          <div>
            <input type="submit" name="search-modal" value="検索">
            <input type="button" name="crear-modal"  onclick="clearForm()" value="クリア">
          </div>
        </form>
      </div> 
...
<div class="form-search">
  <form action="taishobutu_index.php" method="post">
    <tr>
      ...
      <td><input type="button" name= "crear" onclick="clearForm()" value="クリア"></td>
    </tr>
  </form>
</div>
