...
<div class="form-wrapper">
    <form method="post" action="taishobutu_check.php">
        ...
        <input type="text" name="taishobutu_tel" maxlength="13" placeholder="例: 03-1234-5678"><br/>
        ...
        <input type="text" name="owners_tel" maxlength="13" placeholder="例: 090-1234-5678"><br/>
