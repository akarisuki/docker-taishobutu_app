        ...
        <table>
            <thead>
              <tr>
                ...
                <th class="hide-on-mobile" id="1_area">職務上の地位</th>
                <th class="2_area">防火管理者名</th>
                <th class="3_area">選任年月日</th>
                <th class="hide-on-mobile" id="4_area">消防計画届年月日</th>
                <th class="5_area">編集・削除</th>
              </tr>
            </thead>
            <tbody id="tableBody">
              <?php $i = 1; ?>
              ...
              <?php while ($i <= 20): ?>
                <tr>
                  <td class="code_area"><?php echo $i++; ?></td>
                  <td class="hide-on-mobile" id="1_area"><span class="display-value"></span></td>
                  <td class="2_area"><span class="display-value"></span></td>
                  <td class="3_area"><span class="display-value"></span></td>
                  <td class="hide-on-mobile" id="4_area"><span class="display-value"></span></td>
                  <td class="5_area">
