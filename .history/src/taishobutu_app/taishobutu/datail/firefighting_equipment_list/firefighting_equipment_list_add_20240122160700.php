...
<body>
  ...
  <div class="FireEquipmentLimitedQuantity">
    <form method="POST" action="firefighting_equipment_list_add_done.php">
  ...
  <script src="../../../common/script/datail/firefighting_equipment_list/firefighting_equipment_list_script.js"></script> 
</body>