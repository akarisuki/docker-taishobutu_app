...
$sql = <<<EOD
  UPDATE firefighting_equipment_list SET code = :code , StorageBatteryEquipmentGR = :StorageBatteryEquipmentGR ,StorageBatteryEquipmentAI = :StorageBatteryEquipmentAI, StorageBatteryEquipmentNOI = :StorageBatteryEquipmentNOI,
  ...
  FireExtinguisherGR = :FireExtinguisherGR, FireExtinguisherAI = :FireExtinguisherAI, FireExtinguisherNOI = :FireExtinguisherNOI ,updated_at = :updated_at
EOD;
...
$_SESSION['code'] = $code;
header('Location: firefighting_equipment_list_show.php?code=' . urlencode($code));
exit();
