...
<div class="form-wrapper"> 
    <form method="post" action="taishobutu_edit_check.php">
        ...
        <input type="text" name="taishobutu_tel" maxlength="15" value="<?= htmlspecialchars($taishobutu_tel, ENT_QUOTES, 'UTF-8') ?>"><br/>
        ...
        <input type="text" name="owners_tel" maxlength="15" value="<?= htmlspecialchars($owners_tel, ENT_QUOTES, 'UTF-8') ?>"><br/>
