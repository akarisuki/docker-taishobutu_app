    ...
    <div class="popup-inner">
      ...
      <!-- ここに検索フォーム -->
        <form action="taishobutu_index.php" method="post">
            ...
            <div>
              <label>防火対象物名</label>
              <input type="text" class="modal_taishobutu_name" name="search_taishobutu_name" placeholder="すべて" value="<?php if(!empty($search_taishobutu_name)){echo $search_taishobutu_name; }?>">
            </div>
            <div>
              <label>防火対象物所在地</label>
              <input type="text" class="modal_taishobutu_address"  name="search_taishobutu_address" placeholder="すべて" value="<?php if(!empty($search_taishobutu_address)){echo $search_taishobutu_address; }?>">
            </div>
            <div>
              <label>延べ面積</label>
              <input type="text" class="modal_search_total_area" name="search_total_area" placeholder="すべて"value="<?php if(!empty($search_total_area)){echo $search_total_area; }?>">
            </div>
            <div>
